...
DNSDAWG is based on Steve Hanov's implemention of a Directed Acyclic Word Graph, as described on his blog at http://stevehanov.ca/blog/?id=115 It is designed to be as memory efficient as possible.
...
This particular implementation may be different from others because it is very memory efficient. It can deal with thousands of branches out of a single node without needing to go through each one.
